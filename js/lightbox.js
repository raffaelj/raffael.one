...
(function (root, factory) {
  ...
  Lightbox.prototype.build = function() {
    var self = this;
    $('<div id="lightboxOverlay" class="lightboxOverlay"></div><div id="lightbox" class="lightbox"><div class="lb-outerContainer"><div class="lb-container"><img class="lb-image" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" /><div class="lb-nav"><a class="lb-prev" href="" ></a><a class="lb-next" href="" ></a></div><div class="lb-loader"><a class="lb-cancel"></a></div></div></div><div class="lb-dataContainer"><div class="lb-data"><div class="lb-details"><span class="lb-caption"></span><span class="lb-number"></span><span class="lb-photographer"></div><div class="lb-closeContainer"><a class="lb-close"></a></div></div></div></div>').appendTo($('body'));
  ...
  Lightbox.prototype.start = function($link) {
    ...
    this.$lightbox.css({
      ...
      // center image vertically - nächste Zeile auskommentiert
      //https://github.com/lokesh/lightbox2/issues/172#issuecomment-50877681
      // top: top + 'px',
      left: left + 'px'
  ...
  Lightbox.prototype.changeImage = function(imageNumber) {
    ...
    this.$lightbox.find('.lb-image, .lb-nav, .lb-prev, .lb-next, .lb-dataContainer, .lb-numbers, .lb-caption, .lb-photographer').hide();
  ...
  Lightbox.prototype.updateDetails = function() {
    ...
    // Ende eigene Änderung (data-photographer)
